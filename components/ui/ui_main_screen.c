...
{
    /* 右上图标 */
    label_wifi_icon = lv_label_create(lv_scr_act()); //WiFi图标
    ...
    /* 时间 */
    label_time_colon = lv_label_create(lv_scr_act()); //时间的冒号
    ...
    label_time_hour = lv_label_create(lv_scr_act()); //时间的小时
    ...
    label_time_minute = lv_label_create(lv_scr_act()); //时间的分钟
    ...
    /* 天气图标 */
    label_weather_icon = lv_label_create(lv_scr_act()); //天气图标
    ...
    /* 城市与天气文本 */
    label_city = lv_label_create(lv_scr_act()); //城市名称
    ...
    label_weather = lv_label_create(lv_scr_act()); //天气
    ...
    /* gif动图 */
    image_gif = lv_gif_create(lv_scr_act());
    ...
    /* 温湿度与体感温度 */
    label_temperature = lv_label_create(lv_scr_act()); //温度
    ...
    label_humidity = lv_label_create(lv_scr_act()); //湿度
    ...
    label_feels_like = lv_label_create(lv_scr_act()); //体感温度
    ...
    /* 天气预报-明天 */
    label_forecast1_day = lv_label_create(lv_scr_act()); //明天文本
    ...
    label_forecast1_weather = lv_label_create(lv_scr_act()); //天气
    ...
    label_forecast1_temp = lv_label_create(lv_scr_act()); //温度范围
    ...
    /* 天气预报-后天 */
    label_forecast2_day = lv_label_create(lv_scr_act()); //后天文本
    ...
    label_forecast2_weather = lv_label_create(lv_scr_act()); //天气
    ...
    label_forecast2_temp = lv_label_create(lv_scr_act()); //温度范围
...
{
    lv_obj_del(label_wifi_icon);

    lv_obj_del(label_time_hour);
    lv_obj_del(label_time_colon);
    lv_obj_del(label_time_minute);

    lv_obj_del(label_date);

    lv_obj_del(label_weather_icon);
    lv_obj_del(label_city);
    lv_obj_del(label_weather);
    
    lv_obj_del(label_temperature);
    lv_obj_del(label_humidity);
    lv_obj_del(label_feels_like);

    lv_obj_del(label_forecast1_day);
    lv_obj_del(label_forecast1_temp);
    lv_obj_del(label_forecast1_weather);
    lv_obj_del(label_forecast2_day);
    lv_obj_del(label_forecast2_temp);
    lv_obj_del(label_forecast2_weather);
}
